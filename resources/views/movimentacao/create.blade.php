...
<div class="card card-primary card-outline  col-xl-6 offset-xl-3"> <!--begin::Header-->
    ...
    <form action="/movimentacao/cad" method="post" id="newMovFin"> <!--begin::Body-->
        @csrf
        <input type="hidden" name="return" value="/movimentacao">
        <div class="card-body">
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 mb-3">
                    <div class="form-check">
                        <input type="checkbox" name="cartao" id="cartao" class="form-check-input">
                        <label for="cartao" class="form-check-label">Transação no cartão de crédito?</label>
                    </div>
                </div>
                <div class="form-group col-xl-6 col-md-6 mb-3" id="cartaoId">
                    <label for="cartaocredito_id" class="form-label">Cartão de crédito:</label>
                    <select name="cartaocredito_id" id="cartaocredito_id" class="form-select">
                        <option value="" selected disabled>Selecione o cartão de crédito...</option>
                        @foreach($cartao as $dados)
                            <option value="{{$dados->id}}">{{$dados->NomeCartao}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="form-group mb-3">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="PagoMovimentacaoFinanc" name="PagoMovimentacaoFinanc"> 
                        <label class="form-check-label" for="PagoMovimentacaoFinanc">Valor está pago/recebido?</label> 
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 mb-3" id='divida'>
                    ...
                    <select name="divida_id" id="divida_id" class="form-select">
                        ...
                        @foreach($divida as $dados)
                            <option value="{{$dados->id}}">{{$dados->NomeDivida}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 mb-3" id='meta'>
                    ...
                    <select name="meta_id" id="meta_id" class="form-select">
                        ...
                        @foreach($meta as $dados)
                            <option value="{{$dados->id}}">{{$dados->NomeMeta}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-xl-6 col-md-6 mb-3" id='investimento'>
                    ...
                    <select name="investimento_id" id="investimento_id" class="form-select">
                        ...
                        @foreach($investimento as $dados)
                            <option value="{{$dados->id}}">{{$dados->NomeInvestimento}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
