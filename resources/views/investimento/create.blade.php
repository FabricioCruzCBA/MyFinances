...
<div class="card card-primary card-outline  col-xl-6 offset-xl-3"> <!--begin::Header-->
    ...
    <form action="/investimento/cad" method="post"> <!--begin::Body-->
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="form-group mb-3">
                    <label for="NomeInvestimento" class="form-label">Descrição:</label>
                    <input type="text" name="NomeInvestimento" id="NomeInvestimento" class="form-control" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xl-12 col-md-12 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="ValorInicialInvestimento" id="ValorInicialInvestimento" class="form-control Numero" required>
