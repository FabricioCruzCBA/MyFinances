...
@section('Content')
    ...
    <div class="card card-primary card-outline  col-xl-8 offset-xl-2 mb-3"> <!--begin::Header-->
        <div class="card-header">
            <div class="card-title">Registro de Meta</div>
            ...
            <div class="card-footer"> 
                <div class="row">
                    <div class="col-5 col-xl-3">
                        <button type="button" class="btn btn-primary" onclick="location.href = '/meta/edit/{{$meta->id}}';">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <tr class="align-middle">
                            @foreach($meta->metaMovimentacao->sortBy('DataMovimentacaoMeta')->where('AtivoMovimentacaoMeta','1') as $itens)
                                <tr>
                                    <td>{{$itens->id}}.</td>
                                    <td>{{date('d/m/Y',strtotime($itens->DataMovimentacaoMeta))}}</td>
                                    <td>
                                        @if($itens->TipoMovimentacaoMeta == 'E') 
                                    ...
                                    <td class="@if($itens->TipoMovimentacaoMeta == 'E') text-success @else text-danger @endif">
                                        {{
                                            number_format(
                                               $itens->ValorMovimentacaoMeta,
                                                0,
                                                ',',
                                                '.'                                    
                                            )
                                    ...
                                    <td>{{$itens->ObsMovimentacaoMeta}}</td>
                                </tr>
                            @endforeach
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Atualizar meta: {{$meta->NomeMeta}}</h1>
      ...
      <div class="modal-body">
        <form action="/meta/atualizar/" method="post">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6 mb-6">
                    <div class="form-group">
                        <label for="DataMovimentacaoMeta" class="form-label">Data do movimento:</label>
                        <input type="date" name="DataMovimentacaoMeta" id="DataMovimentacaoMeta" class="form-control" required>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6 mb-3">
                    <div class="form-group">
                        <label for="TipoMovimentacaoMeta" class="form-label">Tipo de atualização:</label>
                        <select name="TipoMovimentacaoMeta" id="TipoMovimentacaoMeta" class="form-select" required>
                            <option value="" selected disabled>Selecione o tipo de atualização...</option>
                            <option value="E">Aumento da meta</option>
                            <option value="S">Diminição da meta</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 mb-3">
                    <label for="ValorMovimentacaoMeta" class="form-label">Valor:</label>
                    <div class="input-group">
                        <span class="input-group-text">R$</span>
                        <input type="text" name="ValorMovimentacaoMeta" id="ValorMovimentacaoMeta" class="form-control Numero" required>
                        <span class="input-group-text">,00</span>
                    </div>
                </div>
                <div class="form-group col-xl-6 col-md-6 mb-3">
                    <label for="ObsMovimentacaoMeta" class="form-label">Observação:</label>
                    <input type="text" name="ObsMovimentacaoMeta" id="ObsMovimentacaoMeta" class="form-control" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 mb-3">
