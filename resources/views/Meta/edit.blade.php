...
<div class="card card-primary card-outline  col-xl-6 offset-xl-3"> <!--begin::Header-->
    <div class="card-header">
        <div class="card-title">Atualizar Meta</div>
    </div> <!--end::Header--> <!--begin::Form-->
    <form action="/meta/update/{{$meta->id}}" method="post"> <!--begin::Body-->
        @csrf
        @method('put')
        <div class="card-body">
            <div class="row">
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="NomeMeta" id="NomeMeta" class="form-control" value="{{$meta->NomeMeta}}" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-xl-6 col-md-6 mb-3">
                    <label for="DataFimMeta" class="form-label">Data alvo:</label>
                    <input type="date" name="DataFimMeta" id="DataFimMeta" class="form-control" value="{{$meta->DataFimMeta}}" required>
                </div>
                <div class="form-group col-xl-6 col-md-6 mb-3">
                    <label for="ValorMeta" class="form-label">Valor:</label>
                    <div class="input-group">
                        <span class="input-group-text">R$</span>
                        <input type="text" name="ValorMeta" id="ValorMeta" class="form-control Numero" value="{{$meta->ValorMeta}}" required>
